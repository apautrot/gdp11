...
public class GoTweenCollectionConfig
{
	...
	public GoUpdateType propertyUpdateType = Go.defaultUpdateType;
 	...
 	public Action<AbstractGoTween> onIterateHandler;
	...
	/// <summary>
	/// sets the onIterate handler for the Tween
	/// </summary>
	public GoTweenCollectionConfig onIterate ( Action<AbstractGoTween> onIterate )
	{
		onIterateHandler = onIterate;
		return this;
	}
