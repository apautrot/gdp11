...
public static class GoKitTweenExtensions
{
	...
	public static GoTween scaleFrom ( this Transform self, float duration, float endValue, bool isRelative = false )
	{
		return self.scaleFrom ( duration, new Vector3 ( endValue, endValue, endValue ), isRelative );
	}
