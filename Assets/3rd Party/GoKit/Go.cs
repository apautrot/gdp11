...
public class Go : MonoBehaviour
{
	...
	public static GoEaseType defaultEaseType = GoEaseType.QuadInOut; // GoEaseType.Linear;
	...
	public static List<AbstractGoTween> Tweens { get { return _tweens; } }
	...
	public string getTweensDump ()
	{
		string dump = "";
		for ( int i = 0 ; i < _tweens.Count; i++ )
		{
			if ( i > 0 ) dump += "\n";
			dump += _tweens[i].ToString ();
		}
...
//	int fakeUpdateCount = 0;
	...
	{
// 		if ( updateType == GoUpdateType.Update )
// 		{
// 			if ( fakeUpdateCount > 0 )
// 			{
// 				deltaTime = 0.5f;
// 				fakeUpdateCount--;
// 			}
// 
// 			Debug.Log ( "UT:" + deltaTime );
// 		}
	...
	public static void dumpAllTweens ()
	{
		if ( Tweens.Count > 0 )
		{
			Debug.Log ( "Remaining " + Tweens.Count + " tween(s)." );
			for ( int i = 0; i < Tweens.Count; i++ )
				Debug.Log ( Tweens[i].ToString () );
		}
		else
			Debug.Log ( "No tweens remaining" );
	}
